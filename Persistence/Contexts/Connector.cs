...
namespace Persistence.Contexts
{
    public class Connector
    {
        ...
        public Connector(string dataSource, string cache, string? password = null)
        {
            ConnectionString = new SqliteConnectionStringBuilder(connectionString(dataSource, cache))
            {
        ...
        // Data Source=c:\mydb.db;Cache=Shared;
        private string connectionString(string dataSource, string cache) =>
            $"Data Source={dataSource};Cache={cache};";
